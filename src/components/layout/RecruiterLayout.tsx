    ...
    <div className="min-h-screen bg-surface">
      <aside className="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-40 lg:flex lg:w-64 lg:flex-col glass-panel border-r border-outline-light">
        <div className="flex h-16 items-center gap-2.5 px-5 border-b border-outline-light">
          ...
          <span className="ml-auto text-[10px] font-semibold bg-primary-50 text-primary-700 px-2 py-0.5 rounded-full">Recruiter</span>
        </div>
        ...
        <div className="p-3 border-t border-outline-light">
          <Link to="/recruiter/company" className="flex items-center gap-3 px-3 py-2 hover:bg-surface-container rounded-xl transition-colors">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-on-surface truncate">{recruiterUser.name}</p>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 h-14 glass-panel border-b border-outline-light flex items-center justify-between px-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] font-semibold bg-primary-50 text-primary-700 px-1.5 py-0.5 rounded-full">Recruiter</span>
        </div>
        <div className="flex items-center gap-2">
        ...
        <div className="lg:hidden fixed inset-0 z-50">
          ...
          <div className="absolute top-0 left-0 right-0 glass-panel shadow-xl p-4">
            <div className="flex items-center justify-between mb-4">
              <span className="text-base font-bold text-on-surface">Recruiter Portal</span>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden xl:block">
                <p className="text-sm font-medium text-on-surface">{recruiterUser.name}</p>
