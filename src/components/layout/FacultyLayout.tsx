            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive ? 'bg-primary-50 text-primary-700' : 'text-on-surface-variant hover:bg-surface-container hover:text-on-surface'
                )}
              >
        ...
        <div className="p-3 border-t border-outline-light">
          <Link to="/profile" className="flex items-center gap-3 px-3 py-2 hover:bg-surface-container rounded-xl transition-colors">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-on-surface truncate">{facultyUser.name}</p>
        ...
        <div className="lg:hidden fixed inset-0 z-50">
          ...
          <div className="absolute top-0 left-0 right-0 glass-panel shadow-xl p-4">
            <div className="flex items-center justify-between mb-4">
               <span className="text-base font-bold text-on-surface">Trainer Portal</span>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden xl:block">
                <p className="text-sm font-medium text-on-surface">{facultyUser.name}</p>
                <p className="text-xs text-on-surface-variant">Trainer</p>
              </div>
            </div>
